...
<div class="min-h-screen flex items-center justify-center bg-gray-50 white:bg-gray-700 p-4"
    ...
    <div class="flex flex-col sm:flex-row w-full max-w-[900px] h-auto sm:h-[500px] rounded-2xl overflow-hidden shadow-lg">
        ...
        <div class="w-full sm:w-1/2 flex flex-col justify-center items-center p-6 sm:p-10 bg-white">
            <div class="mb-8 w-full max-w-[80vh] mx-auto">
                <img src="{{ asset('logo_BemDigital.png') }}" alt="Doare" class="w-[35vh] h-auto mx-auto">
            </div>
        ...
        <div class="hidden sm:flex w-1/2 bg-[#0e1523] flex-col justify-center items-center text-white p-10 border-l-2 border-green-500">
            ...
            <img src="{{ asset('icone-planta.png') }}" alt="Ícone" class="h-40 w-auto">
        </div>
