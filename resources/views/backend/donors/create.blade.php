...
<nav class="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
    <ol class="list-reset flex">
        ...
        <li>
            <a href="{{ route('users.index') }}" class="text-blue-600 hover:underline">Doadores</a>
            <span class="mx-2">/</span>
        </li>
        <li class="text-gray-700 font-semibold">Criar Doadores</li>
    </ol>
</nav>
<x-card>
    <form action="{{ route('donors.store') }}" class="space-y-5" method="post">
        @csrf
        <!-- Nome e Telefone -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                <x-input-label for="cpf" required value="CPF" />
