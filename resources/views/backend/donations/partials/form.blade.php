...
<div x-data="{ type: '{{ $oldType }}' }" class="space-y-5">
    <div>
        <x-input-label for="type" required value="Tipo da doação" />
        <select name="type" required class="select" id="type" x-model="type">
            <option disabled checked value="">Selecione o tipo</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <select name="campaign_id" id="campaign_id" class="select w-full" :disabled="!type" onchange="window.location.href='{{ route('donations.create') }}?campaign_id=' + this.value">
        ...
        <div>
            ...
            <div x-show="type === 'entrada'" x-transition>
                ...
                <select id="user_id" name="user_id" class="select w-full" :disabled="!type || type !== 'entrada'" x-bind:required="type === 'entrada'">
            ...
            <div x-show="type === 'saida'" x-transition>
                ...
                <x-text-input id="recipient_name" class="block mt-1 w-full" type="text" name="recipient_name"
                    :value="old('recipient_name')" x-bind:disabled="!type" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <x-text-input id="" class="block mt-1 w-full" name="quantify" type="number" min="1" :value="$quantify" x-bind:disabled="!type" />
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                :value="old('name', $donationModel->name)" required x-bind:disabled="!type" />
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="4"
            ...
            :disabled="!type">{{ $description }}</textarea>
