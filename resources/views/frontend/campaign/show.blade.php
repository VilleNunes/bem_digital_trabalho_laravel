        ...
        <div class="grid md:grid-cols-2">
            ...
            <div class="relative w-full overflow-hidden">
                <div class="flex transition-transform duration-700" id="carouselInner">
                    ...
                    <img src="{{ asset($photo->filename) }}" alt="Imagem da campanha {{ $campaign->name }}"
                        class="w-full h-96 object-cover flex-shrink-0">
                    @endforeach
                    @else
                    <img src="{{ asset('public/campanha1.jpg') }}" alt="Imagem padrão da campanha"
                        class="w-full h-96 object-cover flex-shrink-0">
                    @endif
                </div>
            ...
            <div class="p-8 flex flex-col justify-center">
                ...
                <div class="space-y-2 mb-6 text-gray-700">
                    <p><span class="font-semibold">Instituição:</span> {{ $campaign->institution->fantasy_name ?? 'Não
                        informada' }}</p>
                    <p><span class="font-semibold">Categoria:</span> {{ $campaign->category->name ?? 'Não informada' }}
                    </p>
