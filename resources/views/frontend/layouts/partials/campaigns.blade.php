...
<style>
  /* Adiciona a classe 'line-clamp-2' do Tailwind se você estiver usando a versão 3 ou superior
     ou precisa de um plugin. Use 'overflow-hidden text-ellipsis whitespace-nowrap' se
     precisar de um corte simples em uma linha sem plugins.
     
     Se você precisa do 'line-clamp' (que é ótimo para limitar o texto a 2 linhas), 
     certifique-se de que ele esteja configurado no seu tailwind.config.js ou use um 
     método CSS/JS alternativo. */
