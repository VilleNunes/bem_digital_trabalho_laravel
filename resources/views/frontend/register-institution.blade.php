  ...
  <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-6 items-center">
    ...
    <div>
      ...
      <p class="text-gray-700 mb-6 text-lg">
        Preencha o formulário ao lado para cadastrar sua organização e fazer parte do Bem Digital — 
    ...
    <!-- Formulário -->
    <div class="bg-green-100 p-8 rounded-2xl shadow-lg">
      <form action="#" method="POST" class="space-y-4">
        <div>
          <label class="block text-sm font-medium text-green-800 mb-1">Nome da instituição*</label>
          <input type="text" class="w-full border border-green-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 outline-none" required>
        </div>
        ...
        <div>
          ...
          <input type="email" class="w-full border border-green-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 outline-none" required>
        </div>

        <div>
          <label class="block text-sm font-medium text-green-800 mb-1">WhatsApp*</label>
          <input type="tel" class="w-full border border-green-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 outline-none" placeholder="+55 (XX) XXXXX-XXXX" required>
        </div>

        <div>
          <label class="block text-sm font-medium text-green-800 mb-1">Tipo de instituição*</label>
          <select class="w-full border border-green-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 outline-none">
            <option>ONG</option>
